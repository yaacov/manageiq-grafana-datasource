...
System.register(['app/plugins/sdk', './css/query-editor.css!'], function (_export, _context) {
  ...
  var QueryCtrl, _createClass, ManageIQDatasourceQueryCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('ManageIQDatasourceQueryCtrl', ManageIQDatasourceQueryCtrl = function (_QueryCtrl) {
        _inherits(ManageIQDatasourceQueryCtrl, _QueryCtrl);

        function ManageIQDatasourceQueryCtrl($scope, $injector, uiSegmentSrv, $q) {
          _classCallCheck(this, ManageIQDatasourceQueryCtrl);

          var _this = _possibleConstructorReturn(this, (ManageIQDatasourceQueryCtrl.__proto__ || Object.getPrototypeOf(ManageIQDatasourceQueryCtrl)).call(this, $scope, $injector));
          ...
          _this.listQueryBy = [{ value: 'ids', text: 'Search by name' }];
          _this.metricTypes = [{ value: 'gauge', text: 'Gauge' }];
        ...
        _createClass(ManageIQDatasourceQueryCtrl, [{
          key: 'getTagsSegments',
        ...
        return ManageIQDatasourceQueryCtrl;
      }(QueryCtrl));

      _export('ManageIQDatasourceQueryCtrl', ManageIQDatasourceQueryCtrl);

      ManageIQDatasourceQueryCtrl.templateUrl = 'partials/query.editor.html';
    }
  };
});
